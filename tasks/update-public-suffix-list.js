...
import { PUBLIC_SUFFIXES_URL, PUBLIC_SUFFIXES_FILE } from "./consts";
...
const convertListToObject = (list) => {
  ...
  const suffixesWithoutSpecialRules = suffixesWithoutCommentsAndSpaces.filter(
    (suffix) => {
