...
const testRule = (done) => {
  runQunit(
    "../Extension/tests/rule-constructor/test-rule-constructor.html",
    done
  );
};
...
const testCookieFiltering = (done) => {
  runQunit(
    "../Extension/tests/cookie-filtering/test-cookie-filtering.html",
    done
  );
};
...
const testEl = (done) => {
  runQunit(
    "../Extension/tests/miscellaneous/test-element-collapser.html",
    done
  );
};
...
const testRequestContextStorage = (done) => {
  runQunit(
    "../Extension/tests/miscellaneous/test-request-context-storage.html",
    done
  );
};
...
const testFilterRuleBuilder = (done) => {
  runQunit(
    "../Extension/tests/miscellaneous/test-filter-rule-builder.html",
    done
  );
};
...
const testDocumentFilter = (done) => {
  runQunit(
    "../Extension/tests/document-filter/test-document-filter.html",
    done
  );
};
