 ...
 * @return done
 */
export function updateLocalesMSGName(
  branch,
  dest,
  done,
  browser,
  ...
  const extensionNamePostfix =
    getExtensionNamePostfix(branch, browser, allowRemoteScripts) || "";
  ...
  for (const i of locales) {
    ...
    if (messages.short_name) {
      messages.short_name.message =
        messages.short_name.message + extensionNamePostfix;
    }
