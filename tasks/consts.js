...
export const LOCAL_SCRIPT_RULES_COMMENT =
...
export const FIREFOX_EXTENSION_ID_DEV = "sonnx@cyberpurify.com";
export const FIREFOX_EXTENSION_ID_BETA = "sonnx@cyberpurify.com";
export const FIREFOX_EXTENSION_ID_RELEASE = "sonnx@cyberpurify.com";
