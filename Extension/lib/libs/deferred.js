...
(function () {
  ...
  isPromise = function (obj) {
    return (
      has(obj, "promise") &&
      typeof (obj != null ? obj.promise : void 0) === "function"
    );
  };
  ...
  execute = function (callbacks, args, context) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      callback = ref[i];
      results.push(
        callback.call.apply(callback, [context].concat(slice.call(args)))
      );
    }
    return results;
  };
  ...
  Deferred = function () {
    ...
    this.promise = function (candidate) {
      ...
      candidate.progress = storeCallbacks(
        function () {
      ...
      candidate.always = function () {
        var ref;
        return (ref = candidate.done.apply(candidate, arguments)).fail.apply(
          ref,
          arguments
        );
      };
