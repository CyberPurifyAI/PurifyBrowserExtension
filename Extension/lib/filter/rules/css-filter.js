/**
 * ----------------------------------------------------------------------------------
 * PurifyBrowserExtension css-filter.js
...
(function (purify, api) {
   ...
   * ABP element hiding rules: http://cyberpurify.com/en/filterrules.html#hideRules
   * CSS injection rules: http://cyberpurify.com/en/filterrules.html#cssInjection
   */
  ...
  CssFilter.prototype = {
    ...
    removeRule: function (rule) {
      ...
      this.domainSensitiveRules = this.domainSensitiveRules.filter(function (
        r
      ) {
        return r.ruleText != ruleText;
      });
    ...
    buildCss: function (domainName, options) {
      ...
      var genericHide =
        (options & GENERIC_HIDE_APPLIED) === GENERIC_HIDE_APPLIED;
     ...
     * http://cyberpurify.com/en/filterrules.html#hideRulesExceptions
     * http://cyberpurify.com/en/filterrules.html#cssInjectionExceptions
     * @private
     */
    ...
    _buildCssByRules: function (rules) {
      ...
      for (var i = 0; i < rules.length; i++) {
        ...
        if (rule.isInjectRule) {
          ...
          ++selectorsCount;
          if (
            selectorsCount % CSS_SELECTORS_PER_LINE === 0 ||
            rule.extendedCss
          ) {
