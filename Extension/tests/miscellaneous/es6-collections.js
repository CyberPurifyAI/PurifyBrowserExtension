/**
 * ----------------------------------------------------------------------------------
 * PurifyBrowserExtension es6-collections.js
...
(function (e) {
  ...
  function n(a, c) {
    ...
    if (c != c || 0 === c) for (b = a.length; b-- && !y(a[b], c); );
    else b = a.indexOf(c);
    return -1 < b;
  }
  function p(a) {
  ...
  function r(a, c) {
    this.has(a)
      ? (this._values[b] = c)
      : (this._values[this._keys.push(a) - 1] = c);
    return this;
  }
  function t(a) {
  ...
  "undefined" == typeof WeakMap &&
    (e.WeakMap = f({ delete: d, clear: h, get: m, has: q, set: r }, !0));
  ...
  "undefined" == typeof WeakSet &&
    (e.WeakSet = f({ delete: d, add: t, clear: h, has: p }, !0));
})(
