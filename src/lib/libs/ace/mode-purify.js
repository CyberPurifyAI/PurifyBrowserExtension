ace.define("ace/mode/css_highlight_rules", [], function(
    require,
    exports,
    module
) {
...
ace.define("ace/mode/doc_comment_highlight_rules", [], function(
    require,
    exports,
    module
) {
...
ace.define("ace/mode/javascript_highlight_rules", [], function(
    require,
    exports,
    module
) {
...
ace.define("ace/mode/csp_highlight_rules", [], function(
    require,
    exports,
    module
) {
    ...
    var CspHighlightRules = function() {
        var keywordMapper = this.createKeywordMapper({
                ...
                variable: "'none'|'self'|'unsafe-inline'|'strict-dynamic'|'unsafe-hashed-attributes'",
            },
            "identifier",
            true
        );
