...
(function () {
  ...
  function attachDependencies(scriptlet) {
    var _scriptlet$injections = scriptlet.injections,
      injections =
        _scriptlet$injections === void 0 ? [] : _scriptlet$injections;
  ...
  function passSourceAndProps(source, code) {
    ...
    var argsString = source.args
      ? "[".concat(source.args.map(JSON.stringify), "]")
      : undefined;
    var params = argsString
      ? "".concat(sourceString, ", ").concat(argsString)
      : sourceString;
  ...
  var parseRule = function parseRule(ruleText) {
    ...
    var opened = function opened(rule, index, _ref) {
      ...
      switch (char) {
        ...
        case ")": {
          transition =
            index === rule.length - 1 ? TRANSITION.CLOSED : TRANSITION.OPENED;
          break;
        }
    ...
    var transitions =
      ((_transitions = {}),
      defineProperty(_transitions, TRANSITION.OPENED, opened),
      defineProperty(_transitions, TRANSITION.PARAM, param),
      defineProperty(_transitions, TRANSITION.CLOSED, function () {}),
      _transitions);
    var sep = {
      symb: null,
    };
    var saver = wordSaver();
    var state = iterateWithTransitions(
      ruleText,
      transitions,
      TRANSITION.OPENED,
      {
  ...
  abortOnPropertyRead.names = [
    "abort-on-property-read", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  abortOnPropertyWrite.names = [
    "abort-on-property-write", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  function preventSetTimeout(source, match, delay) {
    ...
    var shouldLog =
      typeof match === "undefined" && typeof delay === "undefined";
    var INVERT_MARKER = "!";
  ...
  preventSetTimeout.names = [
    "prevent-setTimeout", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  preventSetInterval.names = [
    "prevent-setInterval", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  preventWindowOpen.names = [
    "prevent-window-open", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  function abortCurrentInlineScript(source, property, search) {
    ...
    var setChainPropAccess = function setChainPropAccess(owner, property) {
      ...
      if (base instanceof Object === false && base === null) {
        ...
        console.log(
          "The scriptlet had been executed before the ".concat(
            baseName,
            " was loaded."
          )
  ...
  abortCurrentInlineScript.names = [
    "abort-current-inline-script", // aliases are needed for matching the related scriptlet converted into our syntax
    ...
    var setChainPropAccess = function setChainPropAccess(owner, property) {
      ...
      if (base instanceof Object === false && base === null) {
        ...
        if (source.verbose) {
          ...
          var baseName = props[propIndex - 1];
          console.log(
            "set-constant failed because the property '".concat(
              baseName,
              "' does not exist"
            )
          ); // eslint-disable-line no-console
  ...
  setConstant.names = [
    "set-constant", // aliases are needed for matching the related scriptlet converted into our syntax
    "set-constant.js",
    "ubo-set-constant.js",
    "set.js",
    "ubo-set.js",
  ...
  removeCookie.names = [
    "remove-cookie", // aliases are needed for matching the related scriptlet converted into our syntax
    "cookie-remover.js",
  ...
  function preventAddEventListener(source, eventSearch, funcSearch) {
    var eventSearchRegexp = eventSearch
      ? toRegExp(eventSearch)
      : toRegExp("/.?/");
    ...
    function addEventListenerWrapper(eventName, callback) {
      ...
      return nativeAddEventListener.apply(
        this,
        [eventName, callback].concat(args)
      );
    }
  ...
  preventAddEventListener.names = [
    "prevent-addEventListener", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  function preventBab(source) {
    ...
    window.setTimeout = function (callback) {
      if (typeof callback !== "string" || !babRegex.test(callback)) {
        ...
        return nativeSetTimeout.call.apply(
          nativeSetTimeout,
          [_this, callback].concat(args)
        );
      }
    ...
    var check = function check(str) {
      for (var i = 0; i < signatures.length; i += 1) {
        ...
        for (var j = 0; j < tokens.length; j += 1) {
          var token = tokens[j];
          var found =
            token instanceof RegExp ? token.test(str) : str.indexOf(token) > -1;
  ...
  preventBab.names = [
    "prevent-bab", // aliases are needed for matching the related scriptlet converted into our syntax
    "nobab.js",
    "ubo-nobab.js",
    "bab-defuser.js",
    "ubo-bab-defuser.js",
  ...
  function nowebrtc(source) {
    ...
    var rtcReplacement = function rtcReplacement(config) {
      hit(
        source,
        "Document tried to create an RTCPeerConnection: ".concat(config)
      );
    };
  ...
  nowebrtc.names = [
    "nowebrtc", // aliases are needed for matching the related scriptlet converted into our syntax
    "nowebrtc.js",
    "ubo-nowebrtc.js",
    "ubo-nowebrtc",
  ];
  ...
  function logAddEventListener(source) {
    ...
    function addEventListenerWrapper(eventName, callback) {
      ...
      log(
        'addEventListener("'.concat(eventName, '", ').concat(callbackToLog, ")")
      );
  ...
  logAddEventListener.names = [
    "log-addEventListener", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  noeval.names = [
    "noeval", // aliases are needed for matching the related scriptlet converted into our syntax
    "noeval.js",
    "silent-noeval.js",
    "ubo-noeval.js",
  ...
  preventEvalIf.names = [
    "prevent-eval-if", // aliases are needed for matching the related scriptlet converted into our syntax
    "noeval-if.js",
    "ubo-noeval-if.js",
    "ubo-noeval-if",
  ];
  ...
  preventFab.names = [
    "prevent-fab-3.2.0", // aliases are needed for matching the related scriptlet converted into our syntax
    "nofab.js",
    "ubo-nofab.js",
  ...
  setPopadsDummy.names = [
    "set-popads-dummy", // aliases are needed for matching the related scriptlet converted into our syntax
    "popads-dummy.js",
    "ubo-popads-dummy.js",
    "ubo-popads-dummy",
  ];
  ...
  preventPopadsNet.names = [
    "prevent-popads-net", // aliases are needed for matching the related scriptlet converted into our syntax
    "popads.net.js",
    "ubo-popads.net.js",
    "ubo-popads.net",
  ];
  ...
  preventAdfly.names = [
    "prevent-adfly", // aliases are needed for matching the related scriptlet converted into our syntax
    "adfly-defuser.js",
  ...
  removeAttr.names = [
    "remove-attr", // aliases are needed for matching the related scriptlet converted into our syntax
    "remove-attr.js",
    "ubo-remove-attr.js",
    "ra.js",
    "ubo-ra.js",
  ...
  removeClass.names = [
    "remove-class", // aliases are needed for matching the related scriptlet converted into our syntax
    "remove-class.js",
    "ubo-remove-class.js",
    "rc.js",
    "ubo-rc.js",
  ...
  disableNewtabLinks.names = [
    "disable-newtab-links", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  adjustSetInterval.names = [
    "adjust-setInterval", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  adjustSetTimeout.names = [
    "adjust-setTimeout", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  function jsonPrune(source, propsToRemove, requiredInitialProps, stack) {
    ...
    var log = console.log.bind(console);
    var prunePaths =
      propsToRemove !== undefined && propsToRemove !== ""
        ? propsToRemove.split(/ +/)
        : [];
    var requiredPaths =
      requiredInitialProps !== undefined && requiredInitialProps !== ""
    ...
    function isPruningNeeded(root) {
      ...
      for (var i = 0; i < requiredPaths.length; i += 1) {
        ...
        var hasWildcard =
          ...
          requiredPath.indexOf(".[].") > -1 ||
          requiredPath.indexOf("[].") > -1 ||
          requiredPath.indexOf(".[]") > -1; // if the path has wildcard, getPropertyInChain should 'look through' chain props
        ...
        for (var _i = 0; _i < details.length; _i += 1) {
          if (hasWildcard) {
            ...
            shouldProcess =
              !(details[_i].base[lastNestedPropName] === undefined) ||
              shouldProcess;
          } else {
  ...
  function preventRequestAnimationFrame(source, match) {
    ...
    var rafWrapper = function rafWrapper(callback) {
      ...
      if (shouldLog) {
        var logMessage = 'log: requestAnimationFrame("'.concat(
          callback.toString(),
          '")'
        );
  ...
  preventRequestAnimationFrame.names = [
    "prevent-requestAnimationFrame", // aliases are needed for matching the related scriptlet converted into our syntax
  ...
  function setCookie(source, name, value) {
    ...
    var cookieData = ""
      ...
      .concat(encodeURIComponent(valueToSet), "; ")
      .concat(pathToSet);
    hit(source);
  ...
  function hideInShadowDom(source, selector, baseSelector) {
    ...
    var hideHandler = function hideHandler() {
      ...
      var hostElements = !baseSelector
        ...
        : document.querySelectorAll(baseSelector); // if there is shadow-dom host, they should be explored
  ...
  const redirects = [
    { adg: "1x1-transparent.gif", ubo: "1x1.gif", abp: "1x1-transparent-gif" },
    { adg: "2x2-transparent.png", ubo: "2x2.png", abp: "2x2-transparent-png" },
    { adg: "3x2-transparent.png", ubo: "3x2.png", abp: "3x2-transparent-png" },
    {
      adg: "32x32-transparent.png",
      ubo: "32x32.png",
      abp: "32x32-transparent-png",
    },
    { adg: "amazon-apstag", ubo: "amazon_apstag.js" },
    { adg: "google-analytics", ubo: "google-analytics_analytics.js" },
    { adg: "google-analytics-ga", ubo: "google-analytics_ga.js" },
    {
      adg: "googlesyndication-adsbygoogle",
      ubo: "googlesyndication_adsbygoogle.js",
    },
    { adg: "googletagmanager-gtm", ubo: "googletagmanager_gtm.js" },
    { adg: "googletagservices-gpt", ubo: "googletagservices_gpt.js" },
    { adg: "metrika-yandex-watch" },
    { adg: "metrika-yandex-tag" },
    { adg: "noeval", ubo: "noeval-silent.js" },
    { adg: "noopcss", abp: "blank-css" },
    { adg: "noopframe", ubo: "noop.html", abp: "blank-html" },
    { adg: "noopjs", ubo: "noop.js", abp: "blank-js" },
    { adg: "nooptext", ubo: "noop.txt", abp: "blank-text" },
    { adg: "noopmp3-0.1s", ubo: "noop-0.1s.mp3", abp: "blank-mp3" },
    { adg: "noopmp4-1s", ubo: "noop-1s.mp4", abp: "blank-mp4" },
    { adg: "noopvmap-1.0" },
    { adg: "noopvast-2.0" },
    { adg: "noopvast-3.0" },
    { adg: "prevent-fab-3.2.0", ubo: "nofab.js" },
    { adg: "prevent-popads-net", ubo: "popads.js" },
    { adg: "scorecardresearch-beacon", ubo: "scorecardresearch_beacon.js" },
    { adg: "set-popads-dummy", ubo: "popads-dummy.js" },
    { ubo: "addthis_widget.js" },
    { ubo: "amazon_ads.js" },
  ...
  var uboToAdgCompatibility = objFromEntries(
    validAdgRedirects
      .filter(function (el) {
        return el.ubo;
      })
  ...
  var abpToAdgCompatibility = objFromEntries(
    validAdgRedirects
      .filter(function (el) {
        return el.abp;
      })
  ...
  var adgToUboCompatibility = objFromEntries(
    validAdgRedirects
      .filter(function (el) {
        return el.ubo;
      })
  ...
  var validAdgCompatibility = objFromEntries(
    validAdgRedirects.map(function (el) {
  ...
  var isAdgRedirectRule = function isAdgRedirectRule(rule) {
    var MARKER_IN_BASE_PART_MASK =
      "/((?!\\$|\\,).{1})redirect=(.{0,}?)\\$(popup)?/";
    return (
      !isComment(rule) &&
      rule.indexOf(REDIRECT_RULE_TYPES.ADG.marker) > -1 && // some js rules may have 'redirect=' in it, so we should get rid of them
  ...
  var isAdgRedirectCompatibleWithUbo = function isAdgRedirectCompatibleWithUbo(
    rule
  ) {
  ...
  var convertAbpSnippetToAdg = function convertAbpSnippetToAdg(rule) {
    ...
    var mask =
      rule.indexOf(validator.ABP_SCRIPTLET_MASK) > -1
    ...
    return args
      .split(SEMICOLON_DIVIDER)
      .map(function (args) {
        return getSentences(args)
          .filter(function (arg) {
            return arg;
          })
          .map(function (arg, index) {
  ...
  var convertScriptletToAdg = function convertScriptletToAdg(rule) {
    ...
    if (validator.isUboScriptletRule(rule)) {
      ...
      validator.isAdgScriptletRule(rule) ||
      validator.isComment(rule)
    ) {
      result = [rule];
    }
  ...
  var convertAdgScriptletToUbo = function convertAdgScriptletToUbo(rule) {
    ...
    if (validator.isAdgScriptletRule(rule)) {
      ...
      var adgScriptletObject = Object.keys(scriptletList)
        .map(function (el) {
        ...
        if (uboAlias) {
          ...
          var args =
            parsedParams.length > 0
              ? "".concat(uboName, ", ").concat(parsedParams.join(", "))
              : uboName;
    ...
    var adgModifiers = uboModifiers
      .map(function (el) {
        if (el.indexOf(validator.REDIRECT_RULE_TYPES.UBO.marker) > -1) {
          var uboName = substringAfter(
            el,
            validator.REDIRECT_RULE_TYPES.UBO.marker
          );
          var adgName =
            validator.REDIRECT_RULE_TYPES.UBO.compatibility[uboName];
          return ""
            .concat(validator.REDIRECT_RULE_TYPES.ADG.marker)
            .concat(adgName);
        }
  ...
  var convertAbpRedirectToAdg = function convertAbpRedirectToAdg(rule) {
    ...
    var adgModifiers = abpModifiers
      .map(function (el) {
        if (el.indexOf(validator.REDIRECT_RULE_TYPES.ABP.marker) > -1) {
          var abpName = substringAfter(
            el,
            validator.REDIRECT_RULE_TYPES.ABP.marker
          );
          var adgName =
            validator.REDIRECT_RULE_TYPES.ABP.compatibility[abpName];
          return ""
            .concat(validator.REDIRECT_RULE_TYPES.ADG.marker)
            .concat(adgName);
        }
  ...
  function GoogleSyndicationAdsByGoogle(source) {
    ...
    for (var i = 0; i < adElems.length; i += 1) {
      ...
      if (childNodesQuantity > 0) {
        ...
        areIframesDefined =
          childNodesQuantity === 2 && // the first of child nodes should be aswift iframe
          adElemChildNodes[0].tagName.toLowerCase() === "iframe" &&
          adElemChildNodes[0].id.indexOf(ASWIFT_IFRAME_MARKER) > -1 && // the second of child nodes should be google_ads iframe
    ...
    if (typeof dataLayer.push === "function") {
      dataLayer.push = function (data) {
        if (
          ...
          typeof data.eventCallback === "function"
        ) {
      ...
      try {
        ...
        this.redirects = arrOfRedirects.reduce(function (acc, redirect) {
          return _objectSpread(
            _objectSpread({}, acc),
            {},
            defineProperty({}, redirect.title, redirect)
          );
        }, {});
      } catch (e) {
        // eslint-disable-next-line no-console
        console.log(
          "Was unable to load YAML into JS due to: ".concat(e.message)
        );
        throw e;
      }
    }
