/**
 * ----------------------------------------------------------------------------------
 * PurifyBrowserExtension common.js
...
// dev: d3NzOi8vYWRtaW46YWRtaW5AbG9jYWxob3N0OjE1NjcyL3dz
// pro: d3NzOi8vY2hyb21lX2V4dDozb0tkRllIZzRqMUpVdVlzR3A5M2l1SDIxYzdqM1hUUEBodWIuY3liZXJwdXJpZnkuY29tL3dz
purify.HUB_SUBSCRIBE = "d3NzOi8vY2hyb21lX2V4dDozb0tkRllIZzRqMUpVdVlzR3A5M2l1SDIxYzdqM1hUUEBodWIuY3liZXJwdXJpZnkuY29tL3dz";
    ...
    const StringUtils = {
        ...
        elementToString(element) {
            ...
            for (let i = 0; i < attributes.length; i++) {
                ...
                s.push('="');
                const value =
                    attr.value === null ? "" : attr.value.replace(/"/g, '\\"');
                s.push(value);
                s.push('"');
            }
            s.push(">");
